...
app.use('/atlast/RB', require('./routes/atlastRoutes')) //makes the route atlast/RB/ //& require is like an import so it's looking in the routes folder and then that file (atlastRoutes)
app.use('/atlast/users', require('./routes/userRoutes')) //makes the route name atlast/users and looks for the route types in userRoutes.js in the routes folder
